...
@section('content')
    <div class="ol-card">
        <div class="ol-card-body p-3">
                ...
                <div class="ol-card-body px-2" id="filters-container">
                    <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                        ...
                        <div class="top-bar d-flex align-items-center">
                            ...
                            <button
                                onclick="rightCanvas('{{ route(get_current_user_role() . '.addon.ticket.category.create') }}', 'Create category')"
            ...
            <input type="hidden" value="ticket_category" id="datatable_type">
    ...
    <script>
        setTimeout(function() {
            server_side_datatable('["id","title","status","options"]',
                '{{ route(get_current_user_role() . '.addon.ticket.category') }}');
        }, 500);
    </script>
@endpush
