        ...
        <div class="ol-card-body p-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                        ...
                        <div class="top-bar d-flex align-items-center">
                            <div class="input-group dt-custom-search">
                                ...
                                <input type="text" class="form-control" id="custom-search-box" name="customSearch"
                                    placeholder="Search">
                            </div>
                            <button
                                onclick="rightCanvas('{{ route(get_current_user_role() . '.addon.ticket.priority.create') }}', 'Create category')"
            ...
            <div class="d-none d-lg-block">
                <div class="page-length-select fs-12px margin--40px d-flex align-items-center position-absolute">
                    ...
                    <label for="page-length-select" class="ps-2 w-100"> of {{ count($priorities) }}</label>
                </div>
            </div>


            <input type="hidden" value="ticket_priority" id="datatable_type">
...
@push('js')
    ...
    <script>
        setTimeout(function() {
            server_side_datatable('["id","title","status","options"]',
                '{{ route(get_current_user_role() . '.addon.ticket.priority') }}');
        }, 500);
    </script>
@endpush
