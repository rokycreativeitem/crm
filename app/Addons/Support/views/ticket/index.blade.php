...
@section('content')
                ...
                <div class="ol-card-body p-3 position-relative" id="filters-container">
                                ...
                                <div class="top-bar flex-wrap d-flex align-items-center">
                                        ...
                                        <ul class="dropdown-list dropdown-export">
                                            <li class="mb-1">
                                                <a class="dropdown-item export-btn" href="#"
                                                    onclick="downloadPDF('.server-side-datatable', 'Project-list')"><i
                                    ...
                                    <div class="custom-dropdown dropdown filter-dropdown btn-group" id="export-btn">
                                        ...
                                        <div class="dropdown-menu px-14px" aria-labelledby="filterDropdownButton">
                                            ...
                                            <div class="mb-3">
                                                <label for="category"
                                                    class="form-label">{{ get_phrase('Category') }}</label>
                                                <select class="form-control px-14px ol-form-control ol-select2"
                                            ...
                                            <div class="mb-3">
                                                <label for="priority"
                                                    class="form-label">{{ get_phrase('Priority') }}</label>
                                                <select class="form-control px-14px ol-form-control ol-select2"
                                                    name="priority" id="priority">
                                                    <option value="all">{{ get_phrase('Select priority') }}</option>
                                            ...
                                            <div class="mb-3">
                                                <label for="status"
                                                    class="form-label">{{ get_phrase('Status') }}</label>
                                                <select class="form-control px-14px ol-form-control ol-select2"
                                            ...
                                            <div class="mb-3">
                                                <label for="status"
                                                    class="form-label">{{ get_phrase('Client') }}</label>
                                                <select class="form-control px-14px ol-form-control ol-select2"
                                            ...
                                            <div class="mb-3">
                                                <label for="staff"
                                                    class="form-label">{{ get_phrase('Staff') }}</label>
                                                <select class="form-control px-14px ol-form-control ol-select2"
                                                    name="staff" id="staff">
                                            ...
                                            <div class="text-end">
                                                <button type="button" id="filter"
                                                    class="btn btn-apply px-14px">{{ get_phrase('Apply') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        onclick="rightCanvas('{{ route(get_current_user_role() . '.addon.ticket.create') }}', 'Add Ticket')"
                        ...
                        <table class="table server-side-datatable" id="table_list">
                            <thead>
                                <tr class="context-menu-header">
                                    ...
                                    {{-- <th scope="col">{{ get_phrase('Assigned To') }}</th> --}}
                                    @if (get_current_user_role() == 'admin')
                                        <th scope="col">{{ get_phrase('Assigned To') }}</th>
                                    @endif
                    ...
                    <div class="d-none d-lg-block">
                        <div class="page-length-select fs-12px margin--40px d-flex align-items-center position-absolute">
                            ...
                            <label for="page-length-select" class="ps-2 w-100"> of {{ count($tickets) }}</label>
                        </div>
                    </div>


                    <input type="hidden" value="ticket" id="datatable_type">
                    {{-- <button id="addon-delete-selected" class="btn btn-custom-danger mt-3 d-none">
    ...
    @include('Support::components.custom_scripts')
    @include('components.datatable')
    {{-- @include('script') --}}
    @push('js')
        <script>
            const is_customer = '{{ get_current_user_role() }}';
            let column;

            if (is_customer === 'client') {
            ...
            setTimeout(function() {
                server_side_datatable(
                    column,
                    "{{ route(get_current_user_role() . '.addon.ticket') }}"
                );
            }, 500);
        </script>
    @endpush
