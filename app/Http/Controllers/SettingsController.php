...
class SettingsController extends Controller
{
    ...
    public function payment_settings_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', get_phrase('Payment settings update successfully.'));
    }
    ...
    public function notification_settings_store(Request $request, $param1 = '', $id = '')
    {
        ...
        if ($param1 == 'edit_email_template') {
            ...
            return redirect()->back()->with('success', get_phrase('Email template update successfully.'));
    ...
    public function language_store(Request $request)
    {
        ...
        if (Language::where('name', 'like', $request->language)->count() == 0) {
            ...
            return redirect()->back()->with('success', get_phrase('Language added successfully.'));
    ...
    public function language_delete($id)
    {
        ...
        return redirect()->back()->with('success', get_phrase('Language deleted successfully.'));
