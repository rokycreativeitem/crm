    ...
    <div class="ol-card radius-8px print-d-none">
        <div class="ol-card-body my-3 py-3 px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <button onclick="rightCanvas('{{ route(get_current_user_role() . '.permission.create') }}', 'Create permission')" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                                        ...
                                        <td>
                                            <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                <div class="dAdmin_profile_name">
                                                    <h4 class="title fs-12px">{{ $permission->title }}</h4>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                <div class="dAdmin_profile_name">
                                                    <h4 class="title fs-12px">{{ $permission->route }}</h4>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="print-d-none">
                                            <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" onclick="rightCanvas('{{ route(get_current_user_role() . '.permission.edit', $permission->id) }}', 'Edit permission')" href="#">{{ get_phrase('Edit') }}</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" onclick="confirmModal('{{ route(get_current_user_role() . '.permission.delete', $permission->id) }}')" href="javascript:void(0)">{{ get_phrase('Delete') }}</a>
                                                    </li>
                                                </ul>
                                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#delete-selected', function() {
                ...
                if (selectedIds.length > 0) {
                    multiDelete("{{ route(get_current_user_role() . '.permission.multi-delete') }}", selectedIds);
