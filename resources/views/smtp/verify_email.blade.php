                    ...
                    <div style="border-top: 1px solid #dbdfeb; margin-bottom: 0;">
                        ...
                        <div style="font-weight: 400; font-size: 16px; line-height: 24px; color: #6d718c; ">
                            ...
                            <p style="margin: 24px 0">
                                {{ get_phrase('This is your verification code:') }}
                            </p>
                            <p style="margin: 0; color: #212534; line-height: 48px; font-weight: 600; font-size: 48px;">44500
                            </p>
                            <p style="margin-bottom: 24px;">
                                {{ get_phrase('Whether you`re here for your brand, for a cause, or just fun welcome! .') }}
                            </p>
                            <p style="margin: 0;">
                                {{ get_phrase('This code will only be valid for the next 5 minutes.If the does not work , you can use this login verification link:') }}
                            </p>
                        </div>
                        <a href="" style="display: inline-block; background: #1b84ff; text-decoration: none; font-weight: 600; border-radius: 6px; color: #ffffff; font-size: 14px; padding: 19px 45px; margin-top: 24px;">{{ get_phrase('Verify Email') }}</a>
                    </div>
