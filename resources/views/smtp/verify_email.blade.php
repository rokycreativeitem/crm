                ...
                <div style="padding: 40px 48px;">
                    ...
                    <div style="font-weight: 500; font-size: 16px; line-height: 24px; color: #212534; margin-top: 0;">
                        <p style="margin: 24px 0;">
                            This email was sent to <a href="#" style="color: #1b84ff;">angel@creativeitem.com</a>. If you`d rather not receive this kind of email.Don`t want any more emails from Notable?       <a href="#" style="color: #1b84ff;">Unsubscribe</a>.
                        </p>
                        <p style="margin: 0;">
                            100 Smith Street, Melbourne VIC 3000
                        </p>
                        <div style="display: flex; align-items: center; justify-content: space-between;">
                            <span>&copy; 2025 Creativeitem</span>
