        ...
        <div style="max-width: 640px; width: 100%; margin: 0 auto; background: #ffffff;">
            <div style="padding: 40px 48px;">
                ...
                <div style="margin: 30px 0; border-top: 1px solid #dbdfeb;">
                    <h1 style="margin: 30px 0 24px 0; font-weight: 600; font-size: 24px; line-height: 24px; color: #212534;">{{ get_phrase('Thank You for Your Payment✨') }}</h1>
                    <div style="font-weight: 400; font-size: 16px; line-height: 24px; color: #6d718c;">
                        <p style="margin-bottom: 24px;">
                            {{ get_phrase('Hi David,') }}
                        </p>
                        <p style="margin: 0;">
                            {{ get_phrase('Thank you for your payment! We’re thrilled to have you as a valued customer and appreciate your trust in us.') }}
                        </p>
                    </div>
                </div>
