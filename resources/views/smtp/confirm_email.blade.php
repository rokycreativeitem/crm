        ...
        <div style="max-width: 640px; width: 100%; margin: 0 auto; background: #ffffff;">
            <div style="padding: 40px 48px;">
                ...
                <div style="margin: 30px 0; border-top: 1px solid #dbdfeb;">
                    <h1 style="margin: 30px 0 24px 0; font-weight: 600; font-size: 24px; line-height: 24px; color: #212534;">{{ get_phrase('Confirm your email address') }}</h1>
                    <div style="font-weight: 400; font-size: 16px; line-height: 24px; color: #6d718c;">
                        <p>
                            {{ get_phrase('Hi David,') }}
                        </p>
                        <p style="margin-bottom: 24px;">
                            {{ get_phrase('We’re glad to have you onboard! You’re already on your way to creating beautiful visual products.') }}
                        </p>
                        <p style="margin: 0;">
                            {{ get_phrase('Whether you’re here for your brand, for a cause, or just for fun — welcome! If there’s anything you need, we’ll be here every step of the way.') }}
                        </p>
                    </div>
                    <a href="" style="display: inline-block; background: #1b84ff; text-decoration: none; font-weight: 600; border-radius: 6px; color: #ffffff; font-size: 14px; padding: 19px 45px; margin-top: 24px;">{{ get_phrase('Confirm Email Address') }}</a>
                </div>
                <div style="font-weight: 500; font-size: 16px; line-height: 24px; color: #212534; ">
                    <p style="margin-bottom: 24px;">
                        {{ get_phrase('This email was sent to ') }} <a href="#" style="color: #1b84ff;">angel@creativeitem.com</a>. {{ get_phrase('If you`d rather not receive this kind of email.Don`t want any more emails from Notable? ') }}
