                                            ...
                                            <ul class="dropdown-list dropdown-export">
                                                <li class="mb-1">
                                                    <a class="dropdown-item export-btn"
                                                        onclick="exportFile('{{ route(get_current_user_role() . '.addon.export-file', ['file' => 'pdf']) }}')"
                                                ...
                                                <li class="mb-1">
                                                    <a class="dropdown-item export-btn"
                                                        href="javascript:void(0)" onclick="exportFile('{{ route(get_current_user_role() . '.addon.export-file', ['file' => 'csv']) }}')">
                                                ...
                                                <li>
                                                    <a class="dropdown-item export-btn" target="_blank" href="javascript:void(0)" onclick="printFile('{{ route(get_current_user_role() . '.addon.export-file', ['file' => 'print']) }}')"><i class="fi-rr-print"></i>
                                                        {{ get_phrase('Print') }}</a>
                                                </li>
                                            </ul>
...
@push('js')
    <script>
        "use strict";
        server_side_datatable('["id","name","version","status","options"]', "{{ route(get_current_user_role() . '.addons') }}");
