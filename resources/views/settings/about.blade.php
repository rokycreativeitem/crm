                                        ...
                                        <table class="table eTable">
                                            <div class="chart-widget-list">
                                                <p class="border-bottom mb-2 pb-2 text-13px">
                                                    ...
                                                    <span class="float-end ml-5">{{ get_settings('version') }}</span>
                                                </p>
                                                <p class="border-bottom mb-2 pb-2 text-13px">
                                                    <i class="fi-rr-hand-back-point-right me-3"></i>
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px">
                                                    ...
                                                    <span class="float-end"><a class="about-sc-one" href="http://support.creativeitem.com" target="_blank"> <i class="bi bi-telegram"></i>
