    ...
    <head>
        ...
        <title>Project management | Forgot password</title>
                        ...
                        <div class="col-md-6 col-lg-5">
                            <div class="login-form-wrap">
                                <form class="form" method="POST" action="{{ route('password.store') }}">
                                    @csrf
                                    <h1 class="title fs-36px mb-20px">{{ get_phrase('Create New Password') }}</h1>
                                    ...
                                    <div class="mb-3">
                                        <label for="email" class="form-label ol2-form-label mb-3">{{ get_phrase('Email') }}</label>
                                        <input type="email" class="form-control ol2-form-control password-field" id="email" name="email" value="{{ old('email', $request->email) }}" placeholder="{{ get_phrase('Enter Your Password') }}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="password" class="form-label ol2-form-label mb-3">{{ get_phrase('Password') }}</label>
                                        <div class="password-input-wrap">
                                            <input type="password" class="form-control ol2-form-control password-field" id="password" name="password" placeholder="{{ get_phrase('Enter Your Password') }}">
                                            <div class="password-toggle-icons">
                                                <span class="password-toggle-icon fs-5" toggle=".password-field"><i class="fi fi-rr-eye-crossed"></i></span>
                                                <span class="password-toggle-icon fs-5 d-none password-toggle-icon-show" toggle=".password-field"><i class="fi fi-rr-eye"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="password" class="form-label ol2-form-label mb-3">{{ get_phrase('Confirm Password') }}</label>
                                        <div class="password-input-wrap">
                                            <input type="password" class="form-control ol2-form-control password-field" id="password_confirmation" name="password_confirmation" autocomplete="new-password" placeholder="{{ get_phrase('Confirm Password') }}">
                                            <div class="password-toggle-icons">
                                                <span class="password-toggle-icon fs-5" toggle=".password-field"><i class="fi fi-rr-eye-crossed"></i></span>
                                                <span class="password-toggle-icon fs-5 d-none password-toggle-icon-show" toggle=".password-field"><i class="fi fi-rr-eye"></i></span>
                                            </div>
