                            ...
                            <div class="top-bar d-flex align-items-center">
                                ...
                                <div class="custom-dropdown" id="export-btn1">
                                    ...
                                    <ul class="dropdown-list dropdown-export">
                                        <li class="mb-1">
                                            <a class="dropdown-item export-btn" href="#" onclick="downloadPDF('.server-side-datatable', 'invoice-list')"><i class="fi-rr-file-pdf"></i>
                                                {{ get_phrase('PDF') }}</a>
                                        </li>
                                        <li>
...
@push('js')
    <script>
        ...
        setTimeout(function() {
            server_side_datatable('["id","title","payment","time","due_date","payment_status","options"]', "{{ route(get_current_user_role() . '.invoice') }}");
        }, 500);
    </script>
@endpush
