        ...
        <div class="col-12">
            <div class="ol-card p-4">
                <div class="card-body">
                    ...
                    <a href="{{route(get_current_user_role() . '.invoice.payout', $invoice->id)}}" class="in-btn"> {{get_phrase('Pay')}} </a>
                    <p class="in-note"><strong>{{get_phrase('NOTE')}}</strong>: {{get_phrase('All accounts are to be paid within 7 days from receipt of invoice. To be paid
