                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                            ...
                            <div class="top-bar d-flex align-items-center">
                                <div class="input-group dt-custom-search">
                                    ...
                                    <input type="text" class="form-control" id="custom-search-box" value="{{$search??''}}" placeholder="Search">
                                </div>
                                ...
                                <div class="custom-dropdown filter-dropdown" id="export-btn">
                                    ...
                                    <div class="dropdown-menu px-14px" aria-labelledby="filterDropdownButton">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control px-14px" name="budget" id="budget">
                                                <option value="all">{{get_phrase('Select budget')}}</option>
...
<script>
    function grid_view() {
        var search = $("#custom-search-box").val();
        var page_item = $("#page-length-select").val();
        var layout = "grid";
        $.ajax({
            url: "{{ route(get_current_user_role().'.projects',['layout'=>'grid']) }}",
            type: 'GET',
            data: { search: search, layout:layout, page_item:page_item },
