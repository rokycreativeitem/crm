                            ...
                            <div class="top-bar d-flex align-items-center">
                                ...
                                <div class="custom-dropdown dropdown filter-dropdown btn-group" id="export-btn">
                                    ...
                                    <div class="dropdown-menu px-14px" aria-labelledby="filterDropdownButton">
                                        ...
                                        <div class="mb-3">
                                            <label for="budget"
                                                class="form-label">{{ get_phrase('Budget') }}</label>
                                            <div class="accordion-item-range">
                                                ...
                                                <div class="accordion-range-value d-flex align-items-center mt-4">
                                                    <div class="d-flex align-items-center">
                                                        <label for="min-price" class="me-2">
                                                            {{ get_phrase('From') }} </label>
                                                        <input type="text" class="value minPrice" disabled
                                                            id="min-price" name="minPrice">
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <label for="max-price" class="mx-2"> {{ get_phrase('To') }}
                                                        </label>
                                                        <input type="text" class="value" disabled id="max-price"
                                                            name="maxPrice">
                                                    </div>
                                                </div>
                                            </div>
