                                    ...
                                    <ul class="dropdown-list dropdown-export">
                                        <li class="mb-1">
                                            <a class="dropdown-item export-btn" href="#"
                                                onclick="downloadPDF('.server-side-datatable', 'Task-list')"><i
                                    ...
                                    <div class="dropdown-menu px-14px" aria-labelledby="filterDropdownButton">
                                        ...
                                        <div class="mb-3">
                                            <label for="start_date"
                                                class="form-label">{{ get_phrase('Start Date') }}</label>
                                            <input type="datetime-local" name="start_date" id="start_date"
                                                placeholder="{{ get_phrase('Start date') }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="datetime-local" name="end_date" id="end_date"
                                                placeholder="{{ get_phrase('End date') }}"
                                                class="form-control fs-14px">
                                        </div>
                                        <div class="mb-3">
                                            <label for="type"
                                                class="form-label">{{ get_phrase('File Type') }}</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="uploaded_by"
                                                class="form-label">{{ get_phrase('Uploaded by') }}</label>
                                            <select class="px-14px form-select avalynx-select" name="uploaded_by"
                                                id="uploaded_by">
                                        ...
                                        <div class="mb-3">
                                            <label for="size"
                                                class="form-label">{{ get_phrase('File Size') }}</label>
                                            <select class="form-control px-14px ol2-form-control" name="size"
                                                id="size">
...
@push('js')
    <script>
        ...
        if (role != 1 && !"{{ has_permission('file.download') }}") {
            hasRolePermission = '["id","title","type","size","date","updated_by","options"]';
        } else if ("{{ has_permission('file.download') }}") {
            hasRolePermission = '["id","title","type","size","date","updated_by","downloaded","options"]';
        } else {
            hasRolePermission = '["id","title","type","size","date","updated_by","downloaded","options"]';
        }

        setTimeout(function() {
            server_side_datatable(hasRolePermission, "{{ route(get_current_user_role() . '.files') }}");
        }, 500);
    </script>
@endpush
