                                    ...
                                    <div class="custom-dropdown filter-dropdown btn-group" id="export-btn">
                                        ...
                                        <div class="dropdown-list custom-dropdown-300px px-14px" id="filter-section">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control px-14px ol-form-control ol-niceSelect"
                                                    name="type" id="type">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="px-14px form-select ol-form-control ol-select2"
                                            ...
                                            <!-- Apply Button -->
                                            <div class="text-end">
                                                <button type="button" id="filter" class="btn btn-apply px-14px"
                                                    onclick="applyFilter('project-filter')">{{ get_phrase('Apply') }}</button>
                                            </div>
                                        </div>
                                    </div>
