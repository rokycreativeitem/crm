    ...
    <div class="ol-card-body">
        ...
        <div class="row mt-2 mb-2 print-d-none">
            <div class="col-md-6 d-flex align-items-center gap-3 d-none" id="table-action-btns">
                ...
                <div>
                    <a href="#" onclick="rightCanvas('{{ route(get_current_user_role() . '.file.create', ['code' => request()->route()->parameter('code')]) }}', 'Create file')" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                            ...
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $file->title }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $file->extension }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $file->size }}{{ get_phrase('MB') }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $file->timestamp_start }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $file->user->name }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name download">
                                        <a href="{{ route(get_current_user_role() . '.file.download', $file->id) }}">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M7.45 9.92028C7.45 10.2212 7.69905 10.4703 8 10.4703C8.30051 10.4703 8.55 10.2283 8.55 9.92028V1.33362C8.55 1.03267 8.30095 0.783618 8 0.783618C7.69905 0.783618 7.45 1.03267 7.45 1.33362V9.92028Z" fill="#6B708A" stroke="#6B708A"
                                                    stroke-width="0.1" />
                                                <path
                            ...
                            <td class="print-d-none">
                                <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" onclick="rightCanvas('{{ route(get_current_user_role() . '.file.edit', $file->id) }}', 'Edit file')" href="#">{{ get_phrase('Edit') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" onclick="confirmModal('{{ route(get_current_user_role() . '.file.delete', $file->id) }}')" href="javascript:void(0)">{{ get_phrase('Delete') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#delete-selected', function() {
                ...
                if (selectedIds.length > 0) {
                    multiDelete("{{ route(get_current_user_role() . '.file.multi-delete') }}", selectedIds);
