<div class="ol-card">
    <div class="ol-card-body">
        <form action="{{ route(get_current_user_role() . '.file.update', $file->id) }}" method="post" enctype="multipart/form-data" id="ajaxForm">
            @csrf
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="fpb7 mb-2">
                        ...
                        <input class="form-control ol-form-control" type="text" id="title" name="title" value="{{ $file->title }}">
                    </div>
                    <div class="fpb7 mb-2">
