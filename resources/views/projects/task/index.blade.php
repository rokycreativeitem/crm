    ...
    <div class="ol-card-body">
        ...
        <div class="row mt-2 mb-2 print-d-none">
            <div class="col-md-6 d-flex align-items-center gap-3 d-none" id="table-action-btns">
                ...
                <div class="">
                    <a href="#" onclick="rightCanvas('{{ route(get_current_user_role() . '.task.create', ['code' => request()->route()->parameter('code')]) }}', 'Create task')" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                        ...
                        <tr class="context-menu" data-id="{{ $task->id }}">
                            ...
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $task->title }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $task->team }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ date('d-m-y', $task->start_date) }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ date('d-m-Y', $task->end_date) }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="dAdmin_profile d-block align-items-center min-w-200px">
                                    <span class="p-2 fs-12px">{{ $task->progress }}%</span>
                            ...
                            <td class="print-d-none">
                                <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" onclick="rightCanvas('{{ route(get_current_user_role() . '.task.edit', $task->id) }}', 'Task')" href="#">{{ get_phrase('Manage') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" onclick="confirmModal('{{ route(get_current_user_role() . '.task.delete', $task->id) }}')" href="javascript:void(0)">{{ get_phrase('Delete') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
