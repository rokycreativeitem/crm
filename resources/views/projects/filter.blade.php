...
<div id="filter-section">
            ...
            <div class="accordion-item-range me-2">
                <div class="accordion-range-value d-flex align-items-center justify-content-between mt-3">
                    <div class="d-flex align-items-center">
                        ...
                        <input type="text" class="value minPrice" value="" disabled id="min-price" name="minPrice">
                    </div>
                    <div class="d-flex align-items-center">
                        {{-- <label for="max-price" class="mx-2"> {{ get_phrase('To') }} </label> --}}
                        <input type="text" class="value" disabled value="" id="max-price" name="maxPrice">
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Apply Button -->
    <div class="fpb7 mb-2">
        <button type="button" onclick="applyFilter('project-filter')" class="ms-auto btn ol-btn-outline-secondary">{{ get_phrase('Apply') }}</button>
    </div>
</div>
