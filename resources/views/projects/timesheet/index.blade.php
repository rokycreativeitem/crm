    ...
    <div class="ol-card-body">
        ...
        <div class="row mt-2 mb-2 print-d-none">
            <div class="col-md-6 d-flex align-items-center gap-3 d-none" id="table-action-btns">
                ...
                <div class="">
                    <a href="#" onclick="rightCanvas('{{ route(get_current_user_role() . '.timesheet.create', ['code' => request()->route()->parameter('code')]) }}', 'Timesheet')" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                            ...
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $timesheet->title }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $timesheet->timestamp_start }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-12px">{{ $timesheet->timestamp_end }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td class="print-d-none">
                                <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" onclick="rightCanvas('{{ route(get_current_user_role() . '.timesheet.edit', $timesheet->id) }}', 'Edit timesheet')" href="#">{{ get_phrase('Edit') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" onclick="confirmModal('{{ route(get_current_user_role() . '.timesheet.delete', $timesheet->id) }}')" href="javascript:void(0)">{{ get_phrase('Delete') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#delete-selected', function() {
                ...
                if (selectedIds.length > 0) {
                    multiDelete("{{ route(get_current_user_role() . '.timesheet.multi-delete') }}", selectedIds);
