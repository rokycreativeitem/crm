                            ...
                            <div class="top-bar d-flex align-items-center">
                                ...
                                <div class="custom-dropdown" id="export-btn1">
                                    ...
                                    <ul class="dropdown-list dropdown-export" >
                                        <li class="mb-1">
                                            <a class="dropdown-item export-btn" href="javascript:void(0)" onclick="exportFile('{{ route(get_current_user_role() . '.milestone.export-file', ['file' => 'pdf']) }}')">
                                        ...
                                        <li class="mb-1">
                                            <a class="dropdown-item export-btn"
                                                href="javascript:void(0)" onclick="exportFile('{{ route(get_current_user_role() . '.milestone.export-file', ['file' => 'csv']) }}')">
                                        ...
                                        <li>
                                            <a class="dropdown-item export-btn" href="javascript:void(0)" onclick="printFile('{{ route(get_current_user_role() . '.milestone.export-file', ['file' => 'print']) }}')">
