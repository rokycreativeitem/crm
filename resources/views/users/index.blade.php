        ...
        $(document).ready(function() {
                ...
                items: {
                    Edit: {
                        ...
                        callback: function(itemKey, opt, e) {
                            ...
                            rightCanvas("{{ url(get_current_user_role() . '/user/edit/') }}" +
                                '/' + id,
                                'Edit user')
                        }
                    },
                    Delete: {
                        ...
                        callback: function(itemKey, opt, e) {
                            const id = opt.$trigger.attr("data-id");
                            confirmModal("{{ url(get_current_user_role() . '/user/delete/') }}" +
                                '/' + id)
                        }
                    }
                }
            ...
            $(document).on('click', '#delete-selected', function() {
                ...
                if (selectedIds.length > 0) {
                    multiDelete("{{ route(get_current_user_role() . '.user.multi-delete') }}", selectedIds);
